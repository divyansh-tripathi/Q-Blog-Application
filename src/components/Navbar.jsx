...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white/80 backdrop-blur-md shadow-md h-20 w-full px-8 flex items-center justify-between sticky top-0 z-50">
      {/* Logo */}
      <figure className="flex flex-row text-lg md:text-3xl font-extrabold tracking-wide">
        
        <span className="text-gray-800"><span className="text-orange-500">Q</span>-Blogs</span>
      </figure>
